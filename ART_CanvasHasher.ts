 ...
 *
 * CHAIN OF CREATION: parentHash embeds a prior creation's proof inside
...
export interface SovereignCreationContext {
  ...
  // Chain of Creation - embeds a parent proof inside a derivative work.
...
export function ART_CanvasHash(
  ...
  // Chain of Creation Lineage Ring
